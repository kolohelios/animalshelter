...
describe('GET /api/pets/cats/{size}', function(){
  ...
  it('should return small cats', function(done){
    server.inject({method: 'GET', url: '/api/pets/cats/small'}, function(response){
  ...
  it('should get no records returned', function(done){
    server.inject({method: 'GET', url: '/api/pets/cats/tiny'}, function(response){
      expect(response.statusCode).to.equal(200);
